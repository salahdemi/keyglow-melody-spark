...
const Index = () => {
  ...
  if (currentView === 'lessons') {
    return (
      <>
        <LessonsView onBack={() => setCurrentView('home')} userProgress={userProgress} setUserProgress={setUserProgress} />
        <BannerAd show={false} />
      </>
    );
  }
  ...
  if (currentView === 'practice') {
    return (
      <>
        <PracticeMode onBack={() => setCurrentView('home')} />
        <BannerAd show={true} />
      </>
    );
  }
  ...
  if (currentView === 'progress') {
    return (
      <>
        <ProgressView onBack={() => setCurrentView('home')} userProgress={userProgress} />
        <BannerAd show={false} />
      </>
    );
  }
